    ...
    if (odczytywanyPlikTekstowy.good()) {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia)) {
            ...
            if (idUsuwanegoAdresata == pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia))
                czyUsunieto = true;
            else if (numerWczytanejLinii == 1 && czyUsunieto == false)
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (numerWczytanejLinii == 2 && czyUsunieto)
                tymczasowyPlikTekstowy << wczytanaLinia;
            else if (numerWczytanejLinii > 2 && czyUsunieto)
...
void PlikZAdresatami::edytujDaneWybranegoAdresata(Adresat adresat)
{
    ...
    if (odczytywanyPlikTekstowy.good() == true)
    {
        while (getline(odczytywanyPlikTekstowy, wczytanaLinia))
        {
            ...
            {
                wczytanaLinia = liniaZDanymiAdresataOddzielonePionowymiKreskami;
            }
